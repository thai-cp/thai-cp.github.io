...
class ProblemTableExtension(Extension):
    ...
    def extendMarkdown(self, md):
        ...
        md.preprocessors.register(
            ProblemTablePreprocessor(self.problems_dir), 'problem_table', 175
        )

class ProblemTablePreprocessor(Preprocessor):
...
def makeExtension(**kwargs):
    return ProblemTableExtension(**kwargs)
