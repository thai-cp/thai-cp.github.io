...
โดยเราใช้ Format Specifier ทั้งในการนำเข้าและส่งออกข้อมูล ซึ่งจะมีรูปแบบดังโค้ดด้านล่าง
...
โดยที่ [some text] เราสามารถเขียนอะไรก็ได้ ที่เราอยากให้ส่งออก ส่วน %FS_i คือ Format Specifier ของตัวแปรที่ i ที่เราต้องการส่งออก โดยเราจะเขียนชื่อของตัวแปร คั่นด้วยเครื่องหมาย comma ตามลำดับที่เราต้องการจะส่งออก ซึ่งหากอขียน format specifier ไม่ตรงกับชนิดของตัวแปร อาจเกิด Error ได้
